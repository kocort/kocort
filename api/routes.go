...
func (s *Server) registerRoutes(engine *gin.Engine) {
	...
	engine.GET("/api/engine/acp/sessions", engineHandler.ACPSessions)
	engine.GET("/api/engine/acp/session/status", engineHandler.ACPSessionStatus)
	engine.GET("/api/engine/acp/session/observability", engineHandler.ACPSessionObservability)
	engine.POST("/api/engine/acp/session/control", engineHandler.ACPSessionControl)
	engine.POST("/api/engine/acp/session/resume", engineHandler.ACPSessionResume)
	engine.POST("/api/engine/acp/sessions/resume-persistent", engineHandler.ACPSessionsResumePersistent)
