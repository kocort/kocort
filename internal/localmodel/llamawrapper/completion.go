...
func (e *Engine) streamChat(ctx context.Context, seq *sequence, out chan<- ChatCompletionChunk, id, model string, parser *streamParser) {
	// Initial role chunk.
...
func (e *Engine) nonStreamChat(ctx context.Context, seq *sequence, out chan<- ChatCompletionChunk, id, model string, parser *streamParser) {
