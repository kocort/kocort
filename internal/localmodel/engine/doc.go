// package engine is a standalone local LLM inference library built on top
// of llama.cpp via the localmodel/ffi pure-Go dynamic loading bindings.
//
// It provides:
...
//	    Addr:      "127.0.0.1:8080",
//	    EngineConfig: engine.EngineConfig{ModelPath: "/path/to/model.gguf"},
//	})
